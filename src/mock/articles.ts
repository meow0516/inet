...
const articles: Array<Article> = [
  {
    ...
    title: "Dog 0",
    body: "Donec imperdiet venenatis turpis, nec placerat tortor vehicula a. Phasellus enim lectus, lacinia nec mi quis, ullamcorper rhoncus turpis. Class aptent taciti sociosqu ad litora torquen...",
    author: {
      id: 1,
      username: "robot",
      name: "Robot",
  ...
  },
  {
    ...
    title: "Dog 1",
    body: "Nulla tempus, augue non bibendum euismod, ex orci vehicula arcu, eu accumsan arcu dui ut velit. Vivamus placerat nunc massa, a tincidunt tellus egestas vel. Aenean viverra ullamcorper dignissim. Phase...",
    author: {
      id: 2,
      username: "octopus",
      name: null,
